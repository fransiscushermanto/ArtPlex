...
<body>
    <div id="root">
        ...
        <?php $auth->hasUser() || $route->has("login") || $route->has("register") || $route->has("forget") || !$route->notFoundHandler($route->getCurrentPathName()) ? null : include_once("./api/view/layout/footer.php") ?>
        <!-- loader -->
